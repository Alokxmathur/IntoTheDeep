...
public class SparkFunOTOSDrive extends MecanumDrive {
    public static class Params {
        ...
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(-0.25, 6.0, Math.toRadians(180));
        ...
        public double linearScalar = 96.0/92.63;
    ...
    public static SparkFunOTOS.Pose2D RRPoseToOTOSPose(Pose2d pose) {
        return new SparkFunOTOS.Pose2D(pose.position.x, pose.position.y, pose.heading.toDouble());
    }
    public static Pose2d OTOSPoseToRRPose(SparkFunOTOS.Pose2D pose) {
    ...
    public SparkFunOTOSDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        otos = hardwareMap.get(SparkFunOTOS.class, RobotConfig.OTOS);
        // RR localizer note:
