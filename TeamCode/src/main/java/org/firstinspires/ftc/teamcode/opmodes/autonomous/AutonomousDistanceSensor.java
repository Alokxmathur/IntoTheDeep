...
import org.firstinspires.ftc.teamcode.robot.operations.DriveInDirectionToObject;
...
/**
 * This is v3 of the IntoTheDeep autonomous
 * This one uses the distance sensor on the arm to pick up specimens from the wall
 ...
 */
public abstract class AutonomousDistanceSensor extends AutonomousHelper {
    ...
    public void start() {
        super.start();
        State state = new State("Leave wall");
        state.addPrimaryOperation(new DriveInDirectionOperation(-5*Field.MM_PER_INCH,
         ...
         */
        state = new State("Reach submersible");
        state.addPrimaryOperation(new DriveInDirectionOperation(-(DISTANCE_TO_SUBMERSIBLE-5*Field.MM_PER_INCH),
                0, RobotConfig.CAUTIOUS_SPEED/2,
                "Reach submersible"));
        ...
        state.addPrimaryOperation(new DriveInDirectionToObject(2*Field.TILE_WIDTH,
                2*Field.MM_PER_INCH, Math.toRadians(0), .15, "Reach second specimen"));
        state.addPrimaryOperation(new ArmOperation(ArmOperation.Type.Hold, "Grab specimen"));
        states.add(state);

        state = new State("Grab specimen from wall and reach submersible");
        state.addSecondaryOperation(new ArmOperation(ArmOperation.Type.High_Chamber, "Ready for high chamber"));
        state.addPrimaryOperation(new StrafeRightToAprilTagOperation(0, "Strafe to reach submersible"));
        state.addPrimaryOperation(new DriveInDirectionOperation(-14*Field.MM_PER_INCH, 0, RobotConfig.CAUTIOUS_SPEED, "Go back to submersible"));
        //state.addPrimaryOperation(new DriveToAprilTag(0, DISTANCE_TO_SUBMERSIBLE, "Reach submersible specimen 2"));
        states.add(state);
        ...
        state.addPrimaryOperation(new DriveInDirectionToObject(2*Field.TILE_WIDTH,
                2*Field.MM_PER_INCH, Math.toRadians(0), .15, "Reach 3rd specimen"));
        state.addPrimaryOperation(new ArmOperation(ArmOperation.Type.Hold, "Grab specimen"));
        states.add(state);
        ...
        state.addPrimaryOperation(new StrafeRightToAprilTagOperation(0, "Strafe to reach submersible"));
        state.addPrimaryOperation(new DriveInDirectionOperation(-14*Field.MM_PER_INCH, 0, RobotConfig.CAUTIOUS_SPEED, "Go back to submersible"));
        //state.addPrimaryOperation(new DriveToAprilTag(0, DISTANCE_TO_SUBMERSIBLE, "Reach submersible specimen 3"));
        ...
        */
        ...
        state.addPrimaryOperation(new DriveInDirectionOperation(
                ...
                0, RobotConfig.CAUTIOUS_SPEED,
                "Clear submersible"));
        state.addPrimaryOperation(new ArmOperation(ArmOperation.Type.Hold, "Keep specimen if not deposited"));
