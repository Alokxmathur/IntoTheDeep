...
public class FollowerConstants {
    ...
    private static double xMovement = 66;
    private static double yMovement = 48.12525951956201;
    ...
    public static double forwardZeroPowerAcceleration = -28.80328652481287;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -63.493051493014775;
