...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = RobotConfig.LEFT_FRONT_DRIVE;
    public static String leftRearMotorName = RobotConfig.LEFT_REAR_DRIVE;
    public static String rightFrontMotorName = RobotConfig.RIGHT_FRONT_DRIVE;
    public static String rightRearMotorName = RobotConfig.RIGHT_REAR_DRIVE;

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    private static double xMovement = 68.59366349347934;
    private static double yMovement = 51.64559431902067;
    ...
    public static double mass = 10.89;
    ...
    public static double forwardZeroPowerAcceleration = -31.183191108685133;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -59.110124799718974;
