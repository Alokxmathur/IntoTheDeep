...
public abstract class Autonomous extends AutonomousHelper {
    ...
    public void start() {
         ...
         */
        state.addPrimaryOperation(new DriveInDirectionUntilColor(2*Field.TILE_WIDTH,
        ...
        state.addPrimaryOperation(new DriveInDirectionUntilColor(8*Field.MM_PER_INCH,
